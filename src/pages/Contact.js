            ...
            <div className="contact__body">
                ...
                <div className="contact__info_container">
                    ...
                    <div className="contact__info_content_container">
                        ...
                        <span className="contact__email"><i class="fa fa-envelope-open"></i><span className="line"></span>adamgorski1256@gmail.com</span>
                        <span className="contact__phone"><i class="fa fa-phone"></i><span className="line"></span>+44 78 2710 88 35</span>
