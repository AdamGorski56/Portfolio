      ...
      >
        ...
        <div className='my_work__container'>
          ...
          <div className='my_work__project my_work__project_two'>
            <div className='my_work__description'>
              <h2>
                It is an app that I created for me and for the needs of my
                friend. The app shows the current weather conditions and will
                tell you if there is a good time to play tennis in the given
                city.
              </h2>
              <a
          ...
          <div className='my_work__project my_work__project_three'>
            <div className='my_work__description'>
              <h2>
          ...
          <div className='my_work__project my_work__project_four'>
            <div className='my_work__description'>
              <h2>
